        ...
        <header class="tm-header" id="tm-header">
          <div class="tm-header-wrapper">
            ...
            <nav class="tm-nav" id="tm-nav">
              <ul>
                <router-link to="/src/Components/Admin/adminBlog.vue">
              ...
              <form>
                <div class="row g-3">
                  <div class="col-12 col-sm-6">
                    <label for="updatedComment">Yeni Rol Adı:</label>
                    <textarea v-model="name" id="updatedComment"></textarea>
                  ...
                  <br />
                  <router-link to="/src/Components/Admin/adminRole.vue">
                    <a class="nav-item nav-link ">Rol Sayfasına Dön</a>
                  </router-link>
                  <!-- <div class="col-12">
                    <button
                      @click="saveComment"
...
export default {
  ...
  methods: {
    async submitUpdate() {
      const RoleID = this.$route.params.roleID; // Route parametresinden yorum ID'sini al
      const updatedRole = {
        id: RoleID,
        name: this.name,
      };
      ...
      try {
        // Axios veya başka bir HTTP kütüphanesi kullanarak güncelleme isteğini gönder
        // Örneğin: await axios.post("https://your-api-url/UpdateComment", updatedComment);

        axios
          .post("https://localhost:44392/api/Role/UpdateRole", updatedRole)
          .then((response) => {
        ...
        console.log("Yorum güncellendi:", updatedRole);
      } catch (error) {
