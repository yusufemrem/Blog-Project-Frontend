  ...
  <div>
    <html lang="en">
      <head>
        ...
        <!-- Nucleo Icons -->
        <link
          href="/html2-login/assets/css/nucleo-icons.css"
          rel="stylesheet"
        />
      ...
      <body class="g-sidenav-show  bg-gray-100">
        <section class="min-vh-100 mb-8">
          <div
            ...
            style="background-image: url('/html2-login/assets/img/curved-images/curved14.jpg');"
          >
              ...
              <div class="row justify-content-center">
                <div class="col-lg-5 text-center mx-auto">
                  ...
                  <p class="text-lead text-white">
                    Ücretsiz Kayıt Olarak Aramıza Katılabilirsin!
                  </p>
                </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    saveRegister() {
      console.log("girdi");
      this.$store.dispatch("saveRegister", this.user);
      this.$router.push("/");
